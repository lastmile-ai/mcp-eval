...
- Decorators: [test_decorator_style.py](../examples/mcp_server_fetch/tests/test_decorator_style.py)
- Pytest: [test_pytest_style.py](../examples/mcp_server_fetch/tests/test_pytest_style.py)
- Dataset: [test_dataset_style.py](../examples/mcp_server_fetch/tests/test_dataset_style.py), [datasets/](../examples/mcp_server_fetch/datasets/)
...
Sources:
- Unified assertions: [catalog.py](../src/mcp_eval/catalog.py)
- Session/metrics: [session.py](../src/mcp_eval/session.py), [metrics.py](../src/mcp_eval/metrics.py), [span_tree.py](../src/mcp_eval/otel/span_tree.py)
