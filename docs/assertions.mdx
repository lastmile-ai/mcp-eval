...
Catalog source: [catalog.py](../src/mcp_eval/catalog.py)
...
Evaluators source: [evaluators/](../src/mcp_eval/evaluators/)
...
<!-- TODO: Add a comparative example showing immediate vs deferred assertions in the same test with annotations. -->

<!-- TODO: Add a screenshot of a failed assertion section in the combined Markdown report. -->
