...
Source: [datasets.py](../src/mcp_eval/datasets.py)
...
Save/load via `Dataset.to_file` and `Dataset.from_file`. Schema: [mcpeval.config.schema.json](../schema/mcpeval.config.schema.json).

YAML example (from [basic_fetch_dataset.yaml](../examples/mcp_server_fetch/datasets/basic_fetch_dataset.yaml)):
...
- [test_dataset_style.py](../examples/mcp_server_fetch/tests/test_dataset_style.py)
- [datasets/](../examples/mcp_server_fetch/datasets/)
