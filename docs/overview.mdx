...
2. **Production-grade observability** - OpenTelemetry traces capture everything
3. **Rich assertion library** - From simple content checks to sophisticated path analysis
4. **Multiple test styles** - Choose what fits your workflow
5. **Language agnostic** - Test servers written in any language

## Core capabilities

<CardGroup cols={2}>
  <Card title="🧪 Comprehensive Assertions" icon="check-circle">
  ...
  <Card title="🎨 Flexible Test Authoring" icon="code">
    **Decorator style**: Simple `@task` decorators for quick tests
    
    **Pytest integration**: Use familiar pytest fixtures and markers
...
For implementation details, see our [GitHub repository](https://github.com/anthropics/mcp-eval).
