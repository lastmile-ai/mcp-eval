...
```python
# Configure complexity via configuration and compose assertions inside the task
```
...
Control selection via your test runner (markers, CLI flags) rather than decorators.
