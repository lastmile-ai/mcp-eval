...
APIs: [config.py](../src/mcp_eval/config.py), [core.py](../src/mcp_eval/core.py)
...
Examples: [agent_definition_examples.py](../examples/mcp_server_fetch/agent_definition_examples.py)
...
<!-- TODO: Add a short code sample showing AgentSpec with provider/model override and a screenshot of an agent detail view in `mcp-eval list agents --verbose`. -->
