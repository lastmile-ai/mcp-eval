  ...
  <Step title="Add your MCP server">
    ...
    <Tabs>
      ...
      <Tab title="From DXT">
        ...
        ```bash
        mcp-eval add server --from-dxt ~/Desktop/my-server.dxt
        ```
...
- 🐛 **Found a bug?** [Report it on GitHub](https://github.com/anthropics/mcp-eval/issues)
- 💡 **Have ideas?** We'd love to hear them in [discussions](https://github.com/anthropics/mcp-eval/discussions)
