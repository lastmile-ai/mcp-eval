...
<Accordion title="Error: No tools detected from server">
  ...
  **Solutions:**
  ...
  2. **Verify tool discovery:**
     ...
     mcp-eval list tools --server my_server
     ```
...
<Accordion title="Error: Test execution timed out">
  ...
  **Solutions:**
  ...
  5. **Profile slow tests:**
     ...
     mcp-eval run tests/ --profile --html reports/perf.html
     ```
</Accordion>
...
<Accordion title="Error: Assertion failed but seems correct">
  ...
  **Solutions:**
  ...
  3. **Debug actual output:**
     ...
     mcp-eval run tests/ --debug --json debug.json
     ```
...
mcp-eval run tests/ --profile --output profile.json

# Analyze the profile
mcp-eval analyze profile.json
```
...
- 💬 **Discord:** [Join our community](https://lmai.link/discord/mcp-eval)
- 🐛 **GitHub Issues:** [Report bugs](https://github.com/lastmile-ai/mcp-eval/issues)
- 💡 **Discussions:** [Ask questions](https://github.com/lastmile-ai/mcp-eval/discussions)
