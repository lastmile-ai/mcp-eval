...
This is a long-form guide adapted from and expanding on [GUIDE.md](../GUIDE.md). It’s organized for readers who prefer a single page.
...
- [TestSession and TestAgent](../src/mcp_eval/session.py)
- [Decorators and task runner](../src/mcp_eval/core.py)
- [Dataset and Case](../src/mcp_eval/datasets.py)
- [Expect (assertion catalog)](../src/mcp_eval/catalog.py)
- [Evaluators](../src/mcp_eval/evaluators/) and [Metrics](../src/mcp_eval/metrics.py)
- [Runner](../src/mcp_eval/runner.py) and [CLI](../src/mcp_eval/cli/__init__.py)
...
Full example: [test_decorator_style.py](../examples/mcp_server_fetch/tests/test_decorator_style.py)
...
Full example: [test_pytest_style.py](../examples/mcp_server_fetch/tests/test_pytest_style.py)
...
Full example: [test_dataset_style.py](../examples/mcp_server_fetch/tests/test_dataset_style.py) and [basic_fetch_dataset.yaml](../examples/mcp_server_fetch/datasets/basic_fetch_dataset.yaml)
...
Define your agent as the system under test via [use_agent and with_agent](../src/mcp_eval/config.py). See [Agent Evaluation](./agent-evaluation.mdx) for patterns and metrics to watch.
