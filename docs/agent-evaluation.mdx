...
mcp_eval.use_agent(
    AgentSpec(name="Fetcher", instruction="You fetch.", server_names=["fetch"])  # see [Settings](../src/mcp_eval/config.py)
)
```
...
@with_agent(Agent(name="Custom", instruction="Custom", server_names=["fetch"]))  # see [Core](../src/mcp_eval/core.py)
...
def make_agent():
    return Agent(name="Isolated", instruction="...", server_names=["fetch"])  # see [Settings](../src/mcp_eval/config.py)

use_agent_factory(make_agent)
```

More patterns: [agent_definition_examples.py](../examples/mcp_server_fetch/agent_definition_examples.py).
...
- Decorator tests: [test_decorator_style.py](../examples/mcp_server_fetch/tests/test_decorator_style.py)
- Pytest style: [test_pytest_style.py](../examples/mcp_server_fetch/tests/test_pytest_style.py)
- Datasets: [test_dataset_style.py](../examples/mcp_server_fetch/tests/test_dataset_style.py)
...
Sources:
- Session/agent: [session.py](../src/mcp_eval/session.py)
- Catalog: [catalog.py](../src/mcp_eval/catalog.py)
- Evaluators: [evaluators/](../src/mcp_eval/evaluators/)
