...
def create_test_results_table():
    ...
    failure_text_1.append("llm_judge('The summary must be coherent...', min_score=0.8)", style="red")
    failure_text_1.append("\nStatus: ", style="")
    failure_text_1.append("FAIL", style="red")
    failure_text_1.append("\nError: ", style="")
    failure_text_1.append("Judge score 0.2 is below the minimum of 0.8. Reasoning: The summary is not", style="italic red")
    failure_text_1.append("\ncoherent. It is an abrupt truncation of the original sentence and does not form a", style="italic red")
    ...
    failure_text_2.append("objective_succeeded('What time is it in the made-u...')", style="red")
    failure_text_2.append("\nStatus: ", style="")
    failure_text_2.append("FAIL", style="red")
    failure_text_2.append("\nError: ", style="")
    failure_text_2.append("Objective was not met. Reasoning: The agent correctly identified that", style="italic red")
    failure_text_2.append("\n'Atlantis' is not a real timezone and reported the error from the tool, but it", style="italic red")
    failure_text_2.append("\nwas unable to fulfill the user's core objective of getting a time.", style="italic red")
