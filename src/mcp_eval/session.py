...
class TestSession:
    ...
    async def __aenter__(self) -> TestAgent:
        ...
        self.agent = Agent(
            ...
            instruction=self.agent_config.get('instruction', "Complete the task as requested."),
    ...
    def evaluate_now(self, evaluator: Evaluator, response: str, name: str):
        ...
        try:
            ...
            if hasattr(evaluator, 'evaluate_sync'):
                ...
                raise ValueError("Cannot evaluate async evaluator immediately. Use evaluate_now_async() or add_deferred_evaluator()")
    ...
    def _record_evaluation_result(self, name: str, result: Union[bool, float, Dict], error: Optional[str]):
