...
class MCPCaseGenerator:
    ...
    async def generate_cases(
        ...
        if categories is None:
            categories = ['basic_functionality', 'error_handling', 'edge_cases', 'performance']
        ...
        try:
            ...
            for case_data in cases_data.get('cases', []):
                evaluators = self._create_evaluators_for_case(case_data, available_tools)
            ...
            return self._generate_fallback_cases(server_name, available_tools, n_examples)
