...
def contains(session: TestSession, response: str, text: str, case_sensitive: bool = False):
...
def not_contains(session: TestSession, response: str, text: str, case_sensitive: bool = False):
...
def tool_success_rate(session: TestSession, min_rate: float, tool_name: Optional[str] = None):
...
async def judge(session: TestSession, response: str, rubric: str, min_score: float = 0.8):
